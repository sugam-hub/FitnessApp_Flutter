...
class _OnBoardState extends State<OnBoard> {
  ...
  List<OnboardModel> screens = <OnboardModel>[
    OnboardModel(
      ...
      text: "Fit and Healthy",
      desc: "Helping you to take fitness to the top level",
      bg: Colors.white,
      button: Color(0xFF4756DF),
    ),
    OnboardModel(
      img: 'assets/images/food.jpg',
      text: "Food and Nutrients",
      desc: "A healthy body needs healthy food",
      bg: Colors.white,
      button: Color(0xFF4756DF),
    ),
    OnboardModel(
      ...
      text: "Workouts",
      desc: "Rise and shine its cardio time",
      bg: Colors.white,
      button: Color(0xFF4756DF),
    ),
  ];
